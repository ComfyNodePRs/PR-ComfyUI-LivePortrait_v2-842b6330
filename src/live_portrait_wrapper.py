...
class LivePortraitWrapperAnimal(LivePortraitWrapper):
    ...
    def __init__(self, inference_cfg: InferenceConfig):
        ...
        model_config = yaml.load(open('custom_nodes/ComfyUI-LivePortrait_v2/src/config/models.yaml', 'r'), Loader=yaml.SafeLoader)
        # init F
        self.appearance_feature_extractor = load_model('models/Liveportrait_v3/liveportrait_animals/base_models/appearance_feature_extractor.pth', model_config, self.device, 'appearance_feature_extractor')
      
        # init M
        self.motion_extractor = load_model('models/Liveportrait_v3/liveportrait_animals/base_models/motion_extractor.pth', model_config, self.device, 'motion_extractor')
        
        # init W
        self.warping_module = load_model('models/Liveportrait_v3/liveportrait_animals/base_models/warping_module.pth', model_config, self.device, 'warping_module')
        
        # init G
        self.spade_generator = load_model('models/Liveportrait_v3/liveportrait_animals/base_models/spade_generator.pth', model_config, self.device, 'spade_generator')
