...
class CropConfig(PrintableConfig):
    ...
    landmark_ckpt_path: str = make_abs_path("../../../../models/Liveportrait_v3/liveportrait/landmark.onnx")
    ...
    xpose_ckpt_path: str = make_abs_path("../../../../models/Liveportrait_v3/liveportrait_animals/xpose.pth")#######################
